...
a tissue in **multiple temporal snapshots** at the **cellular** and **sub-cellular** level.
...
transcripts **multiple hybridization rounds** in combination with **image microscopy** and **FISH** approach.
...
Technology examples of this family are: *10x Visium Spatial Gene Expression*, *Slide-seq(V2)*, others.
...
<img src="https://github.com/drighelli/EuroBioc2020_SpatialWorkshop/raw/master/inst/imgs/visium_detected_tissue_image.jpg" alt="10x visium mouse brain" width="500"/>

<br>

While we take a snapshot in full resolution of the on-chip places tissue slice,
...
The *SpatialExperiment* class for this workshop is a *devel* version of it, but
we are confident that it'll be the reference class for spot-based family technologies.
...
library(remotes)
install_github("drighelli/SpatialExperiment", ref="eurobioc2020")
...
If you're interested in a **seqFISH dataset** you can retrieve it from the
